			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="login active" action="updatedbpword" method="POST" >
                        ...
                        <tr> <td style="text-align: right;">Database : <img src="resources/images/blguide.png" width="30px" title="enter the database name e.g masterhc" /></td>
                            <td style="text-align: right;"><input id="database"  type=text required name=database value="masterhc" placeholder="e.g masterhc"  class="textbox"/></td>
                        </tr>
