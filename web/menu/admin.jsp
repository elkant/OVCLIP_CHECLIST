<%-- 
    Document   : admin
    Created on : Jun 30, 2015, 11:13:28 PM
    Author     : Emmanuel E
--%>
...
<html dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="ovc lip user menu_files/css3menu1/style.css" type="text/css" /><style type="text/css">._css3m{display:none}</style>
    ...
    <body ontouchstart="" style="background-color:#EBEBEB">
        ...
        <ul id="css3menu1" class="topmenu">
            ...
            <li class="topmenu"><a class="pressed" href="dataentry.htm" style="width:62px;height:25px;line-height:25px;"><img src="ovc lip user menu_files/css3menu1/home2.png" alt=""/>Home</a></li>
            ...
            <li class="topmenu"><a href="#" style="height:25px;line-height:25px;"><span><img src="ovc lip user menu_files/css3menu1/pencil.png" alt=""/>Edit Entries</span></a>
                <ul>
                 ...
                 <li class="topmenu"><a href="#" style="height:25px;line-height:25px;"><span><img src="ovc lip user menu_files/css3menu1/pencil.png" alt=""/>Management</span></a>
                <ul>
                    <li class="sublast"><a href="newuser.htm">Add Users</a></li>
